  ...
  return (
    ...
    <div className="min-h-screen bg-slate-100 text-gray-800">
      ...
      <section className="bg-white py-16 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          <div className="border p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-medium text-primary">Scout Badge</h3>
          ...
          <div className="border p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-medium text-primary">Team Player</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Button className="mt-6 px-8 py-3 text-lg font-semibold bg-primary text-white rounded-md hover:bg-blue-700">
          Sign Up Now
        </Button>
      </section>
